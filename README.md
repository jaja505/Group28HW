...
public class Exs2 {
  ...
  //4. collect all similar WebElements containing movie info on to List
  //5. remove WebElement with movie rating less than 6
  //6. create HTML file
  //7. collect all WebElements from inside <head></head>:
  // target: <link rel="stylesheet" type="text/css">
  // and place them to your HTML file inside <head></head>
  //8. create next element inside <body></body>
  // target: 
  ...
  // <div class="lister-list"></div>
  // 10. open your THML file with driver
}
```
